...
<div class="container article-title" style="">
    <div class="row" style="">
        <div class="col-md-12 mt-3">
            <h1 onClick="reveal(1)" class="text-left mb-3 ml-3 titre_template_page" style="color:white;cursor:pointer;font-size: 22px;">EXPOSITION : <?php _p($article["title"]); ?> <span class="visiter" id="visiter" onClick="visiter()">VISITER <span class="button">▶</span></span><span class="retour" id="retour" onClick="retour()">RETOUR <span class="button">▶</span></span></h1>
        </div>
    </div>
</div>
                ...
                <div id="diapo-<?= $count ?>" class="diapo container">
                    ...
                    <div class="row content" style="margin:0 auto;padding:0 30px 40px 30px;background-color:#fff4d5">
                        ...
                        <div class="col-sm-12" style="margin-top: 1rem">
                            <?php if ($data["subUrl1"]) : ?>
                                <img src="<?php _p($data["subUrl1"]); ?>" style="width:100px; margin-left:10px" />
                            <?php else : ?>
                                <div style="height:200px;"></div>
                            <?php endif; ?>
                            <?php if ($data["subUrl2"]) : ?>
                                <img src="<?php _p($data["subUrl2"]); ?>" style="width:100px; margin-left:10px" />
                            <?php else : ?>
                                <div style="height:200px;"></div>
                            <?php endif; ?>
                            <?php if ($data["subUrl3"]) : ?>
                                <img src="<?php _p($data["subUrl3"]); ?>" style="width:100px; margin-left:10px" />
                            <?php else : ?>
                                <div style="height:200px;"></div>
                            <?php endif; ?>
                            <?php if ($data["subUrl4"]) : ?>
                                <img src="<?php _p($data["subUrl4"]); ?>" style="width:100px; margin-left:10px" />
                            <?php else : ?>
                                <div style="height:200px;"></div>
                            <?php endif; ?>

                            <?php if ($data["subUrl5"]) : ?>
                                <img src="<?php _p($data["subUrl5"]); ?>" style="width:100px; margin-left:10px" />
                            <?php else : ?>
                                <div style="height:200px;"></div>
                            <?php endif; ?>
                        </div>
                    ...
                    <div class="row content" style="margin:0 auto;padding:20px 30px;background-color:#fff4d5">
                        <div class="col-md-12">
                            ...
                            print $object->getWithTemplate('
		                                    <div class="col-md-5 col-md-offset-1 col-sm-10 col-sm-offset-1">
		                                        <a href="#" class="zoomButton" onclick="caMediaPanel.showPanel(\'/index.php/Detail/GetMediaOverlay/context/objects/id/' . $object_id . '/representation_id/' . $representation_id . '/overlay/1\'); return false;">
		                                            <img src="^ca_object_representations.media.page.url" style="height:400px;min-height:400px;width:95%;min-width: auto;max-width: none; object-fit:contain;"/>
		                                        </a>
		                                    </div>
		                                    <div class="col-md-5 col-md-offset-1 col-sm-10 col-sm-offset-1 objecttext">
		                                        <p>(' . $count . '/<span class="total"> </span>)</p>
		                                        <h3>^ca_objects.preferred_labels</h3>
		                                        <p>' . $inrap_musee_chrono . '</p>
		                                        <p>^ca_objects.description</p>
		                                        <ifdef code="ca_objects.inrap_type_struct_archeo">
		                                            <h4>Contexte archéologique</h4>
		                                            <div class="inrap_type_struct_archeo">^ca_objects.inrap_type_struct_archeo</div>
