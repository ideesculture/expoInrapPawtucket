...
class ShowController extends ActionController
{
    ...
    public function __construct(&$po_request, &$po_response, $pa_view_paths = null)
    {
        ...
        $this->opa_view_paths[] = $this->plugin_path."/themes/".$vs_theme."/views/adulte";
    }
...
//            var_dump($art);die();
    ...
    public function Details() {
        ...
        if($page->get("template_id") == "5") {
            $this->redirect("/index.php/Expositions/ShowJeunesse/Details/id/".$id);
        } else {
            $this->view->setVar("article", $article);
